...
public:
    ...
    void setupUi(QDialog *setup_videoClass)
    {
        ...
        spinBox_CCD_Width->setMaximum(8196);
        ...
        spinBox_CCD_Height->setMaximum(8196);
    ...
    void retranslateUi(QDialog *setup_videoClass)
    {
        ...
        groupBox_Video->setTitle(QApplication::translate("setup_videoClass", "Camera", 0, QApplication::UnicodeUTF8));
