...
public:
    ...
    void setupUi(QWidget *guiderClass)
    {
        ...
        spinBox_YScale->setMinimum(1);
        spinBox_YScale->setMaximum(30);
        spinBox_YScale->setSingleStep(1);
        ...
        doubleSpinBox_QualityThreshold2->setMinimum(2);
        ...
        doubleSpinBox_QualityThreshold1->setMinimum(2);
        ...
        l_Status = new QLabel(groupBox_Info);
        l_Status->setObjectName(QString::fromUtf8("l_Status"));
        sizePolicy1.setHeightForWidth(l_Status->sizePolicy().hasHeightForWidth());
        l_Status->setSizePolicy(sizePolicy1);
        l_Status->setFrameShape(QFrame::StyledPanel);
        l_Status->setFrameShadow(QFrame::Sunken);
        l_Status->setMargin(2);

        gridLayout_10->addWidget(l_Status, 3, 0, 1, 4);
        ...
        gridLayout_11->addWidget(l_15, 3, 0, 1, 2);
        ...
        gridLayout_11->addWidget(spinBox_AccFramesRA, 3, 2, 1, 1);
        ...
        gridLayout_11->addWidget(spinBox_AccFramesDEC, 3, 3, 1, 1);
        ...
        gridLayout_11->addWidget(l_Quality, 15, 2, 1, 1);
        ...
        l_37 = new QLabel(groupBox_Control);
        l_37->setObjectName(QString::fromUtf8("l_37"));
        QSizePolicy sizePolicy2(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(l_37->sizePolicy().hasHeightForWidth());
        l_37->setSizePolicy(sizePolicy2);

        gridLayout_11->addWidget(l_37, 2, 0, 1, 2);

        checkBox_normalizeGain = new QCheckBox(groupBox_Control);
        checkBox_normalizeGain->setObjectName(QString::fromUtf8("checkBox_normalizeGain"));
        QSizePolicy sizePolicy3(QSizePolicy::Preferred, QSizePolicy::Fixed);
        sizePolicy3.setHorizontalStretch(0);
        sizePolicy3.setVerticalStretch(0);
        sizePolicy3.setHeightForWidth(checkBox_normalizeGain->sizePolicy().hasHeightForWidth());
        checkBox_normalizeGain->setSizePolicy(sizePolicy3);

        gridLayout_11->addWidget(checkBox_normalizeGain, 2, 2, 1, 1);
        ...
        sizePolicy3.setHeightForWidth(checkBox_AverageFrames->sizePolicy().hasHeightForWidth());
        checkBox_AverageFrames->setSizePolicy(sizePolicy3);

        gridLayout_11->addWidget(checkBox_AverageFrames, 2, 3, 1, 1);
        ...
        QWidget::setTabOrder(spinBox_GuideRate, groupBox_DirRA);
        QWidget::setTabOrder(groupBox_DirRA, checkBox_DirRAPlus);
        QWidget::setTabOrder(checkBox_DirRAPlus, checkBox_DirRAMinus);
        QWidget::setTabOrder(checkBox_DirRAMinus, checkBox_DirDECPlus);
        QWidget::setTabOrder(checkBox_DirDECPlus, groupBox_DirDEC);
        QWidget::setTabOrder(groupBox_DirDEC, checkBox_DirDECMinus);
        QWidget::setTabOrder(checkBox_DirDECMinus, checkBox_normalizeGain);
        QWidget::setTabOrder(checkBox_normalizeGain, checkBox_AverageFrames);
        QWidget::setTabOrder(checkBox_AverageFrames, spinBox_AccFramesRA);
        ...
        QWidget::setTabOrder(spinBox_MinPulseDEC, pushButton_StartStop);
    ...
    void retranslateUi(QWidget *guiderClass)
    {
        ...
        l_28->setText(QApplication::translate("guiderClass", "De-noise", 0, QApplication::UnicodeUTF8));
        ...
        l_Status->setText(QApplication::translate("guiderClass", "status", 0, QApplication::UnicodeUTF8));
        ...
        l_37->setText(QApplication::translate("guiderClass", "Flags", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        checkBox_normalizeGain->setToolTip(QApplication::translate("guiderClass", "Normalize gain coefficients", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        checkBox_normalizeGain->setText(QApplication::translate("guiderClass", "norm.gain", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        checkBox_AverageFrames->setToolTip(QApplication::translate("guiderClass", "Average frames", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
