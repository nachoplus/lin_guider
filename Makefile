...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat Jun 17 16:14:24 2017
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Iinclude -Iinclude/io_dev -Iinclude/video_dev -Iinclude/math -I. -Irelease/.moc -Irelease/.ui
LINK          = g++
LFLAGS        = -Wl,-O1
...
OBJECTS       = release/.obj/drift_graph.o \
		release/.obj/target_graph.o \
		release/.obj/gmath_donuts.o \
		release/.obj/donuts_guide.o \
		release/.obj/guider_math.o \
		release/.obj/io_nexstar.o \
		release/.obj/io_skywatcher.o \
...
release/.obj/drift_graph.o: src/drift_graph.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/.obj/drift_graph.o src/drift_graph.cpp

release/.obj/target_graph.o: src/target_graph.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/.obj/target_graph.o src/target_graph.cpp

release/.obj/gmath_donuts.o: src/math/gmath_donuts.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/.obj/gmath_donuts.o src/math/gmath_donuts.cpp

release/.obj/donuts_guide.o: src/math/donuts_guide.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/.obj/donuts_guide.o src/math/donuts_guide.cpp

release/.obj/guider_math.o: src/math/guider_math.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/.obj/guider_math.o src/math/guider_math.cpp
...
release/.obj/io_skywatcher.o: src/io_dev/io_skywatcher.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/.obj/io_skywatcher.o src/io_dev/io_skywatcher.cpp
